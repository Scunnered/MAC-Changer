...
def get_arguments():
    ...
    parser.add_option("-i", "--interface", dest="interface",
                      help="Interface to change its MAC address")  # terminal side promts to guide user
...
def get_current_mac(interface):
    ...
    mac_address_search_result = re.search(r"\w\w:\w\w:\w\w:\w\w:\w\w",
                                          ifconfig_result)  # rule created on https://pythex.org/
